...
from .schemas import CustomerPayload, PredictionResponse, BatchPayload
from .model_utils import predict_single, predict_batch
...
# allow local frontend (adjust in production)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
