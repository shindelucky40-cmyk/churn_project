...
# Paths (assumes churn_project/app/ and churn_project/models/)
...
# Explicit numeric & categorical order used in training
...
def preprocess_single(payload: Dict[str, Any]) -> np.ndarray:
    """
    Convert a single payload dict into model-ready numpy array (1, n_features)
    """
